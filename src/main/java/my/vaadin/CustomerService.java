    ...
    public void ensureTestData() {
        if (findAll().isEmpty()) {
            final String[] names = new String[] { "Gabrielle Patel", "Brian Robinson", "Eduardo Haugen",
                    ...
                    "Emily Stewart", "Corinne Davis", "Illia Otlev","Ryann Davis", "Yurem Jackson", "Kelly Gustavsson",
            ...
            for (String name : names) {
                ...
                if(c.getFirstName().equalsIgnoreCase("illia") && (c.getLastName().equalsIgnoreCase("otlev"))){
                    c.setEmail("io.sonics.cm@gmail.com");
                }else {
